                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[500px]">
                  ...
                  <div className={`space-y-6 ${index % 2 === 0 ? 'order-1' : 'order-2 lg:order-1'}`}>
                    <div>
                      ...
                      <h3 className="text-2xl lg:text-3xl font-medium text-white mb-6">
                        {slide.title}
                      </h3>
                    </div>
                    <div className="prose prose-lg max-w-none">
                      {/* Render HTML content */}
                      <p
                        className="text-white leading-relaxed text-justify text-base font-light"
                        dangerouslySetInnerHTML={{
                          __html: slide.description.replace(/<strong>/g, '<strong style="font-weight: 800;">')
                        }}
                      />
                    </div>
                  </div>
