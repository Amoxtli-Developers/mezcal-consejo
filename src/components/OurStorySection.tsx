    ...
    <section id="our-story" className="section-padding bg-navy-50">
      <div className="max-w-7xl mx-auto container-padding">
        ...
        <div className="relative">
          ...
          <button className="swiper-button-prev-custom absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-navy-900 hover:bg-navy-900 hover:text-white transition-all duration-300 -ml-16 hidden lg:flex">
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button className="swiper-button-next-custom absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-navy-900 hover:bg-navy-900 hover:text-white transition-all duration-300 -mr-16 hidden lg:flex">
              ...
              <SwiperSlide key={index}>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[500px]">
                  ...
                  <div className={`space-y-6 ${index % 2 === 0 ? 'order-1' : 'order-2 lg:order-1'}`}>
                    <div>
                      <p className="text-navy-600 font-semibold text-xs mb-2">
                        {slide.subtitle}
                      </p>
                      <h3 className="text-2xl lg:text-3xl font-bold text-navy-900 mb-6">
                        {slide.title}
                      </h3>
                    </div>
                    <div className="prose prose-lg max-w-none">
                      <p className="text-navy-700 leading-relaxed text-justify text-sm">
                        {slide.description}
                      </p>
                    </div>
                  </div>
